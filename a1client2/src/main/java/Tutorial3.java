...
public class Tutorial3 extends JFrame {
  public Tutorial3() throws IOException {
    initUI();
  }
  ...
  private void initUI() throws IOException {
    ...
    ChartUtils
        .saveChartAsPNG(new File("histogram.png"), chart, 600, 400);
  ...
  private JFreeChart createChart() {
    ...
    return ChartFactory.createHistogram("Normal distribution",
